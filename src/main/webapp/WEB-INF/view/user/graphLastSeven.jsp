...
<body>
	...
	<div align="left">
		...
		<input type="text"  name="totalAmtlastseven" id="totalAmtlastseven"  style="width: 118px; background-color: lightsalmon; font-weight: bold; height: 40px; margin-top: -1%; font-weight: bold;" disabled>
