...
<title>Graph - Balance Sheet-Month</title>
...
<body>
	...
	<div align="left">
		...
		<br>
			...
			<div class='inline'>
		&nbsp; <select id="yearbalancesheet" style="width: 150px; height: 30px;">
		...
		<input type="text"  name="totalBalanceAmt" id="totalBalanceAmt"  style="width: 118px; background-color: lightsalmon; font-weight: bold; height: 40px; margin-top: -1%; font-weight: bold;" disabled>
...
<figure class="highcharts-figure">
	<div id="containerbalancesheet"></div>
