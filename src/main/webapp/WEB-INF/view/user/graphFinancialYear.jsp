...
<title>Graph - Financial year</title>
...
<link rel="stylesheet" href="resources/css/chartFinancialYear.css">
...
<body>
	...
	<br>
		...
		<div class='inline'>
		&nbsp; <select id="yearfinancialyear" style="width: 150px; height: 30px;">
			<option value="">select year</option>
			<c:forEach items="${yearMaster}" var="yearMaster">
				<option value="${yearMaster.year}"
					${yearMaster == year ? 'selected' : ''}>${yearMaster.financialYear}</option>
			</c:forEach>
		</select>
	</div>
		...
		<input type="text"  name="totalAmt" id="totalAmt"  style="width: 118px; background-color: lightsalmon; font-weight: bold; height: 40px; margin-top: -1%; font-weight: bold;" disabled>
...
<figure class="highcharts-figure">
	<div id="containerFinancialYear"></div>
