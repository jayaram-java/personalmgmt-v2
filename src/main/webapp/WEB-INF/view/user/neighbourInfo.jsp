...
<script type="text/javascript" src="resources/js/neighbourInfo.js"></script>
<body>
...
<section id="main-body">
	...
	<div>
		<table id="neighbourinfodataTable">
			<thead>
				<tr>
					<th>S.no</th>
					<th>Name</th>
